import { Flex, Box, Button, Heading, Text, Card } from '@theme-ui/components'
...
export default function Landing() {
    return (
        <Box style={{ textAlign: 'center', marginTop: '4rem' }}>
            <Heading
                as="h2"
                sx={{ maxWidth: [null, '75%', null, '50%'], margin: '8rem auto 0', fontSize: [5, 6] }}
            >
                .طبق معمول بنویس
                <br />
                .بهتر از همیشه نشر بده
            </Heading>
            <Text as="p" sx={{ maxWidth: ['80%', '65%'], margin: 'auto', my: '7rem', color: 'muted' }}>
            ...
            >
                <Card sx={{ my: '1rem', cursor: 'pointer', mx: '.5rem' }}>
